...
//   },]
    ...
    {field:'monto_plan',headerName:'Monto',type:'number',headerAlign:"left",align: 'left',
    ...
    {field:'pago_acumulado',headerName:'Acumulado',type:'number',headerAlign:"left",align: 'left',
        minWidth:150,flex:0.3,
    ...
    renderCell: (params) => {
      if(params.value==params.row.monto_plan ){
        ...
        return <span className='spanMedDeuda'>{currencyFormatter(params.value)}</span>
      }else{
